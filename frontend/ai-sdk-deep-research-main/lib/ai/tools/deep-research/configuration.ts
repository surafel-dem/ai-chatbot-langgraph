...
export const DeepResearchConfigSchema = z.object({
  ...
  summarization_model_max_tokens: z.number().int().default(10000),
  research_model: z.string().default('gpt-4o-mini'),
  research_model_max_tokens: z.number().int().default(10000),
  compression_model: z.string().default('gpt-4o-mini'),
  compression_model_max_tokens: z.number().int().default(10000),
  final_report_model: z.string().default('gpt-4o'),
  final_report_model_max_tokens: z.number().int().default(10000),
  status_update_model: z.string().default('gpt-4o-mini'),
